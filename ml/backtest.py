...
def load_model_and_meta(s3, bucket, reg_key=None, meta_key=None):
    reg_key = reg_key or f"{MODEL_PREFIX}/latest_reg.pkl"
    meta_key = meta_key or f"{MODEL_PREFIX}/latest_meta.json"
